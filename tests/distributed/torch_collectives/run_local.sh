...
#
#   ./run_local.sh        all 8 test payloads / 13 execution modes; every case must PASS
#   ./run_local.sh pals   all 8 payloads with rank/world resolved from PALS_* only
...
neg)
    ...
    for mode in misroute nan scale offset p2p; do
